...
class TvManageSubscriptionsActivity : FragmentActivity() {
    ...
    companion object {
        ...
        // QR2: https://play.google.com/store/account/subscriptions?product=basic_subscription&package=app.afleet.classytaxi"
        // QR3: https://play.google.com/store/account/subscriptions?product=premium_subscription&package=app.afleet.classytaxi"
